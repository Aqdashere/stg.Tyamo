                            ...
                            return Column(
                              children: [
                                GestureDetector(
                                  ...
                                  child: OneValueCard(
                                    value: status1[index],
                                    clr:  selectedStatus == status1[index] ? Colors.blue.shade400 : Colors.lightBlueAccent.shade100 ,
                                  ),
                                ),
                                GestureDetector(
                                  onTap: (){
                                  ...
                                  child: OneValueCard(
                                    value: status2[index],
                                    clr: selectedStatus == status2[index] ? Colors.blue.shade400 : Colors.lightBlueAccent.shade100 ,
                                  ),
                                ),
                              ],
                            );
