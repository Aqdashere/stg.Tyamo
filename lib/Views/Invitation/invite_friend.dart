      ...
      appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            actions: [
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(type: PageTransitionType.rightToLeft, child: AcceptInvite()));
                },
                child: Padding(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: 40,),
            Text('Search for your Friend on Tyamo or invite \n your friend to Tyamo',
            ...
            ElevatedButton(
                ...
                style: ButtonStyle(
                  ...
                  shape: WidgetStateProperty.all<RoundedRectangleBorder>( //for rounded rectangular border shape
